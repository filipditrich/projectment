...
import {Card, CardBody, CardDeck, CardFooter, CardGroup, CardHeader, Col, Row} from "reactstrap";
            ...
            <>
                <Row className="justify-content-center">
                    <Col sm="12">
                        ...
                        <Card className="mt-3">
                            <CardBody>
                                <button className="button button-primary button-reverse mr-3" onClick={ ()=>{ setEditing(true) } }><span>Editace</span></button>
